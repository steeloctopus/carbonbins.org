...
<div class="uk-section uk-section-secondary uk-preserve-color">
  <div class="uk-container">
    <div class="uk-panel uk-margin-medium">
      <div class="uk-flex-middle" uk-grid>
        <div class="uk-width-2-3@m">
          <h1>How CarbonBins<br/> works.<br/></h1>
          <p>The world has delayed reducing carbon emissions for so long that humanity will need to suck enormous amounts of carbon dioxide back out from the air to avoid catastrophic global warming. We see this challenge as a waste management problem. We have ways to clean up our rubbish, sewerage and streets - why not our carbon waste? Carbon Bins provides a solution to this by crowdfunding the removal of CO<sup>2</sup>  from our atmosphere.</p>
        </div>
    ...
    <div class="uk-grid-match" uk-grid>
      <div class="uk-width-2-3@m" >
        <h2>Put carbon waste in a Carbon Bin - one tank of petrol at a time</h2>
        ...
        <p>CO<sup>2</sup> Australia has developed and managed projects under a range of domestic and international carbon crediting and trading schemes, including the Emissions Reduction Fund (ERF), Carbon Farming Initiative, NSW Greenhouse Gas Abatement Scheme, Greenhouse Friendly Program, New Zealand Emissions Trading Scheme, Verified Carbon Standard and Clean Development Mechanism.</p>
      </div>
      <div class="uk-width-3-2@m" uk-grid>
        <img src="http://via.placeholder.com/640x360?text=Infographic"/>
      </div>
    <div class="uk-width-2-3@m" >
